function makeNode(id, nodeType, rawFields = {}) {
    return {
        id,
        position: { x: 0, y: 0 },
        data: {
...
function makeRoot(id = 'internal:graph-root') {
    return {
        id,
        position: { x: 0, y: 0 },
        data: {
...
function makeEdge(source, target, edgeType) {
    return {
...
export const INTERACTION_CONTRACT_FIXTURES = [
    {
